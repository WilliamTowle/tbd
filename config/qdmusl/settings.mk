...
TARGET_VENDOR=qdmusl
TARGET_LIBC=musl
TARGET_TRIPLET=${TARGET_CPU}-${TARGET_VENDOR}-linux-${TARGET_LIBC}


TARGET_DEPLOY_TYPE=fstree
TARGET_PACKAGES_DIR=${STAGING_DIR}/${TARGET_VENDOR}-packages
TARGET_STAGING_DIR=${STAGING_DIR}/${TARGET_VENDOR}-rootfs
